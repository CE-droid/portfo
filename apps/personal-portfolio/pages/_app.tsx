  ...
  return (
    <Provider {...{ store }}>
      <PersistGate loading={<Preloader />} {...{ persistor }}>
        ...
        >
          <Head>
            <title>Cerine Gousmine - Personal Portfolio</title>
            <meta name="title" content="Cerine Gousmine" />
            <meta
              name="description"
            ...
            <meta property="og:title" content="Cerine Gousmine" />
            <meta
            ...
            />
            <meta property="twitter:title" content="Cerine Gousmine" />
            <meta
